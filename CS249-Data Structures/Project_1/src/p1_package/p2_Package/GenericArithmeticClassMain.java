...
public class GenericArithmeticClassMain
{
    ...
    {
        int index, result, base = 16, decimalValDigits = 5, numDigitArrayDigits = 12,
                arrayCapacity = 50;
        ...
        System.out.println(
                "BC_1: (" + bc_1.getValueAsBase() + ") " + bc_1.getValueAsDecimal());
        System.out.println(
                "BC_2: (" + bc_2.getValueAsBase() + ") " + bc_2.getValueAsDecimal());
    ...
    public static GenericArithmeticClass<BaseClass> createValues(int base, int numItems,
            int numDecimalDigits)
    {
        ...
        BaseClass tempValue;
        GenericArithmeticClass<BaseClass> values = new GenericArithmeticClass<BaseClass>(
                numItems);
