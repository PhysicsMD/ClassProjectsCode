...
public class GenericBSTClassMain
   {
    ...
    private static final int sortDir = StateDataClass.SORT_FORWARD;
      ...
      public static void main(String[] args)
         {
          GenericBSTClass<StateDataClass> testClass;
...
//                                                               StateDataClass.SORT_FORWARD );
          ...
          testClass.displayTree( GenericBSTClass.INORDER_TRAVERSE );
          
          System.out.println( "\nPreorder Display:" );
          
          testClass.displayTree( GenericBSTClass.PREORDER_TRAVERSE );
          
          System.out.println( "\nPostorder Display:" );
          
          testClass.displayTree( GenericBSTClass.POSTORDER_TRAVERSE );
         }

    public static StateDataClass removeItem( GenericBSTClass<StateDataClass> bst, String stateName )
       {
        return bst.removeNode( new StateDataClass( stateName, "", 0, 0.0, 0, 0 ) );
       }
    
    public static StateDataClass searchForItem( GenericBSTClass<StateDataClass> bst, String stateName )
       {
       ...
       */
      private static GenericBSTClass<StateDataClass> uploadData( String fileName )
         {
          String stateName, stateInit;
          int numInst, lowTemp, highTemp;
          double avgTemp;
          StateDataClass dataItem;
          GenericBSTClass<StateDataClass> newData = new GenericBSTClass<StateDataClass>();
