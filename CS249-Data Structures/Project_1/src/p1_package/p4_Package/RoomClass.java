...
/**
 * Class for storing class room information for use in a recursive-backtracking
 * process
 *
 * @author MichaelL
 */
public class RoomClass
{
    ...
    /**
     * associated class index, used to associate this room to a class in search
     * operation
     */
     ...
     * @param inAssocClsIndex index used for associating an element in a class
     *                        array to the room
     */
    public void setRoomData( String inBldgName, int inRoomNum,
                             int inRoomCapacity, int inAssocClsIndex )
    {
    ...
    /**
     * returns index used for associating an element in a class array to the
     * room
     *
    ...
    /**
     * sets index used for associating an element in a class array to the room
     *
    ...
    /**
     * returns information about room object, in the form: "Building Name:
     * _building name_, Room Number: _room number_, Room Capacity: _room
     * capacity_
     *
